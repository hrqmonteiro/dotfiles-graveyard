...
theme.titlebar_ontop_button_normal_inactive_hover = titlebar_icon_path .. "ontop_normal_inactive_hover.png"
theme.titlebar_ontop_button_focus_inactive_hover  = titlebar_icon_path .. "ontop_focus_inactive_hover.png"
theme.titlebar_ontop_button_normal_active_hover = titlebar_icon_path .. "ontop_normal_active_hover.png"
theme.titlebar_ontop_button_focus_active_hover  = titlebar_icon_path .. "ontop_focus_active_hover.png"
